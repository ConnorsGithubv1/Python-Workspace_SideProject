...
def change_action(action_var, frame, new_value):
    if action_var != new_value:
        ...
        frame = 0
        print(action_var, frame)
    return action_var, frame


animation_database = {}

animation_database['run'] = load_animation('player/run', [7, 7, 7, 7, 7])
animation_database['idle'] = load_animation('player/idle', [7, 7, 7, 7])
...
player_rect = pygame.Rect(100, 100, 33, 43)
